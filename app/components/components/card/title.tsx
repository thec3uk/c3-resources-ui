        ...
        <>
          <div className="flex flex-col justify-between col-span-5 row-span-2 md:col-span-11">
            <div className="relative rounded">
              ...
              />
              <div className="absolute bottom-0 object-cover w-full h-56 rounded bg-gradient-to-t from-black lg:from-transparent to-transparent"></div>
          ...
          <div className="flex flex-col col-start-1 row-span-2 mt-4 col-span-full md:col-span-11">{children}</div>
        </>
      ) : ( */}
      <>
        ...
        <div className="flex flex-col h-full col-start-1 row-span-5 mt-4 col-span-full md:col-span-11">{children}</div>
      </>
      {/* )} */}
