...
const NewsletterSignUp = ({ data }) => {
  ...
  return (
    <TitleCard title={data.title} subtitle={data.subtitle} titleImage={data.titleImage} colour={data.colour}>
      <div className="flex flex-col justify-between h-full prose prose-p:lg:text-xl">
        <PrismicRichText field={data.content.richText} fallback={<p>No content</p>} />
