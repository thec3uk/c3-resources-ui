...
export default function ChannelsPage() {
  ...
  const [featured] = useState<Channel>(data.find((f) => f.uid === "c3-kids") || data[0]);
  ...
  return (
    <>
      ...
      <VideoBanner
        ...
        videoUrl={video}
        callToAction={data.map((channel) => ({
          link: `/channels/${channel.uid}`,
          title: channel.name,
        }))}
      />
      {/* {messages && <ImageGrid title="Latest Videos..." items={messages} theme={Theme.light} />} */}
