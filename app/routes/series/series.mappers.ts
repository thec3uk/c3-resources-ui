import { CmsSeries, getUid, getText, getId, CmsResource } from "~/types/cms.types";
...
export function mapResources(cmsResources?: Array<{ resources: CmsResource }>): Array<Resource> | undefined {
  return cmsResources
